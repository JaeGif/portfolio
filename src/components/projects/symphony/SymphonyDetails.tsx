...
function SymphonyDetails() {
  ...
  return (
    <span className='flex w-full p-2 sm:p-5 gap-5'>
      ...
      <div className='flex flex-col sm:flex-row relative sm:w-5/6 shadow-md border-2 dark:border-white border-gray-950 bg-white dark:bg-gray-800 rounded-md mt-5 p-4'>

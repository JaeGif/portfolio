    ...
    <>
      {mounted && (
        <div className='flex gap-2 flex-wrap'>
          <Link href={'https://github.com/JaeGif/Marble-Game'} target='_blank'>
          ...
          <Link href={'https://marble-run-blond.vercel.app/'} target='_blank'>
